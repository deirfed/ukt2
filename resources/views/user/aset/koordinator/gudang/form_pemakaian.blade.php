...
@section('content')
    <div class="row gutters justify-content-center">
        <div class="col-xl-6 col-lg-6 col-md-7 col-sm-8 col-12">
            <form action="{{ route('aset.koordinator.transaksi.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('post')
                <div class="card m-0">
                    ...
                    <div class="card-body">
                        ...
                        <div class="btn group-button">
                            ...
                            <a href="{{ route('aset.koordinator.my-gudang') }}" class="btn btn-dark">Batal</a>
                        </div>
                    </div>
                </div>
            </form>
