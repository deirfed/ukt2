...
@section('path')
    <div class="page-header">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Daftar Barang Gudang Saya</li>
        </ol>
    </div>
@endsection
                ...
                <div class="card-body">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-3 text-left">
                            <div class="d-flex justify-content-start align-items-center flex-wrap">
                                <a href="{{ route('aset.koordinator.index') }}"
                                    ...
                                    Kembali</a>
                                <a href="{{ route('aset.koordinator.form-pemakaian') }}"><button type="submit"
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped" id="dataTable">
                            ...
                            <tbody>
                                <form id="ambil-barang-form" action="{{ route('aset.koordinator.form-pemakaian') }}"
                                    method="GET">
                                    @csrf
                                    @method('GET')
