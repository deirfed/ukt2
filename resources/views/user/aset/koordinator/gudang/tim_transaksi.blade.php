...
@section('path')
    <div class="page-header">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">Gudang Pulau</li>
            <li class="breadcrumb-item active">Histori Pemakaian Tim</li>
        </ol>
    </div>
@endsection
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="d-flex justify-content-center mb-3 text-center" style="text-decoration: underline">Data
                        Transaksi Penggunaan Barang - Tim Pertamanan</h4>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-3 text-left">
                            <div class="d-flex justify-content-start align-items-center flex-wrap">
                                <a href="{{ route('aset.koordinator.index') }}"
                                    ...
                                    Kembali</a>
                                <a href="{{ route('aset.koordinator.my-gudang') }}" class="btn btn-primary mr-2 mb-2 mb-sm-0"><i class="fa fa-building"></i> Ke Gudang</a>
                        ...
                        <table class="table table-bordered table-striped" id="dataTable">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">Fisudur</td>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Filter Data Penggunaan</h5>
