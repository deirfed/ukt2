...
@section('title-head')
    <title>
        Absensi | Daftar Absensi Tim Saya
    </title>
@endsection
...
@section('path')
    <div class="page-header">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('simoja.koordinator.index') }}">Absensi</a></li>
            <li class="breadcrumb-item active">Daftar Absensi Tim Saya</li>
        </ol>
    </div>
@endsection
...
@section('content')
    <div class="row gutters d-flex justify-content-center align-item-center">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="d-flex justify-content-center mb-3 text-center" style="text-decoration: underline">Absensi Tim
                        Saya
                    </h4>
