...
@section('title-head')
    <title>
        Kinerja | Daftar Absensi Tim Saya
    </title>
@endsection
...
@section('path')
    <div class="page-header">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Daftar Kinerja Tim Saya</li>
        </ol>
    </div>
@endsection
...
@section('content')
    <div class="row gutters d-flex justify-content-center align-item-center">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="d-flex justify-content-center mb-3 text-center" style="text-decoration: underline">Kinerja Tim
                        Saya
                    </h4>
                    ...
                    <div class="paginate-style">
                        <div class="d-flex justify-content-center mb-2">
                            <a href="{{ route('simoja.koordinator.kinerja.tim') }}" class="btn btn-primary mr-2 mb-2 mb-sm-0"><i
...
@section('javascript')
    <script type="text/javascript">
        ...
        var route = "{{ route('simoja.koordinator.kinerja.tim') }}";
