...
@section('path')
    <div class="page-header">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Daftar Pengajuan Seksi Pertamanan</li>
        </ol>
    </div>
@endsection
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="d-flex justify-content-center mb-3 text-center" style="text-decoration: underline">Daftar
                        Pengajuan Cuti Seksi Pertamanan</h4>
                                ...
                                <table class="table table-bordered table-striped" id="dataTable">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-center">10/12/2022 - 12/12/2022 <br> (2 Hari)</td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="javascript:;" class="btn btn-dark" title="Lihat lampiran"
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">Jeki</td>
                                            <td class="text-center">Pulau Panggang</td>
                                            <td class="text-center">Eko Aditya <br> (Tim Pertamanan 1)</td>
                                            <td class="text-center">10/12/2022 - 12/12/2022 <br> (2 Hari)</td>
                                            <td class="text-center">Cuti Tahunan</td>
                                            <td class="text-center">
