...
@section('path')
    <div class="page-header">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Data Detail Pulau</li>
        </ol>
    </div>
@endsection
                            ...
                            <ul class="agenda-list">
                                <li>
                                    ...
                                    <div class="details">
                                        ...
                                        <small> Entry Laporan: 09:00 16/2/2024 | Follow Up Laporan: 13:12 10/2/2024 </small>
                                    </div>
                                </li>
                                <li>
                                    <span class="bullet">&nbsp;</span>
