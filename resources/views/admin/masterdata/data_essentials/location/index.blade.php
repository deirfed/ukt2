        ...
        <div class="card">
            <div class="card-body">
                <div class="table-responsive">
                    <div>
                        <a href="{{ route('masterdata-location.create') }}"><button class="btn btn-primary mb-3">Add Data</button></a>
                    </div>
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center">Stasiun Lebak Bulus</td>
                                <td class="text-center">STLBB</td>
                                <td class="text-center">Mainline</td>
                                <td class="text-center">Region 3</td>
