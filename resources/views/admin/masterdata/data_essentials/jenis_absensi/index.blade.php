...
@section('title-head')
    <title>
        Masterdata | Daftar Jenis Absensi
    </title>
@endsection
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3 text-left">
                            ...
                            <a href="{{ route('jenis_absensi.create') }}" class="btn btn-primary">Tambah
                                Data</a>
                        </div>
                    </div>
                                ...
                                @foreach ($jenis_absensi as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('jenis_absensi.edit', $item->uuid) }}"><button
            ...
            <div class="modal-content">
                <div class="modal-body p-2">
                    ...
                    <div class="px-5 pb-8 text-center mt-3">
                        <form action="{{ route('jenis_absensi.destroy') }}" method="POST">
                            @csrf
                            @method('delete')
