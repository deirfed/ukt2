...
@section('title-head')
    <title>
        Masterdata | Daftar Relasi Struktur
    </title>
@endsection
...
@section('path')
    <div class="page-header">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Daftar Relasi Struktur</li>
        </ol>
    </div>
@endsection
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3 text-left">
                            ...
                            <a href="{{ route('struktur.create') }}" class="btn btn-primary">Tambah
                                Data</a>
                        </div>
                    </div>
                            ...
                            <tbody>
                                @foreach ($struktur as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">{{ $item->unitkerja->name ?? '-' }}</td>
                                        <td class="text-center">{{ $item->seksi->name ?? '-' }}</td>
                                        <td class="text-center">{{ $item->tim->name ?? '-' }}</td>
                                        <td class="text-center">
                                            <a href="{{ route('struktur.edit', $item->uuid) }}"><button
            ...
            <div class="modal-content">
                <div class="modal-body p-2">
                    ...
                    <div class="px-5 pb-8 text-center mt-3">
                        <form action="{{ route('struktur.destroy') }}" method="POST">
                            @csrf
                            @method('delete')
