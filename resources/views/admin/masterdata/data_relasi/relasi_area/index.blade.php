...
@section('path')
    <div class="page-header">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Daftar Relasi Area</li>
        </ol>
    </div>
@endsection
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3 text-left">
                            ...
                            <a href="{{ route('area.create') }}" class="btn btn-primary">Tambah
                                Data</a>
                        </div>
                    </div>
                                ...
                                @foreach ($area as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('area.edit', $item->uuid) }}"><button
