...
@section('title-head')
    <title>
        Masterdata | Daftar Relasi Konfigurasi Gudang
    </title>
@endsection
...
@section('path')
    <div class="page-header">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Daftar Relasi Konfigurasi Gudang {{ $this_year }}</li>
        </ol>
    </div>
@endsection
                        ...
                        <table class="table table-bordered table-striped" id="dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Pulau Lokasi</th>
                            ...
                            <tbody>
                                @foreach ($konfigurasi_gudang as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('konfigurasi_gudang.edit', $item->uuid) }}"><button
            ...
            <div class="modal-content">
                <div class="modal-body p-2">
                    ...
                    <div class="px-5 pb-8 text-center mt-3">
                        <form action="{{ route('konfigurasi_gudang.destroy') }}" method="POST">
                            @csrf
                            @method('delete')
