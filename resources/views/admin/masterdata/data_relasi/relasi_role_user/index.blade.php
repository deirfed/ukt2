...
@section('title-head')
    <title>
        Masterdata | Daftar Relasi Role User
    </title>
@endsection
...
@section('path')
    <div class="page-header">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Daftar Relasi Role User</li>
        </ol>
    </div>
@endsection
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3 text-left">
                            ...
                            <a href="{{ route('role_user.create') }}" class="btn btn-primary">Tambah
                                Data</a>
                        </div>
                    </div>
